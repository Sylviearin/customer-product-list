...
export const AddCommentForm: React.FC<Props> = ({item}) => {
    ...
    useEffect(() => {
        if (userComment.length > 0) {
            ...
            if (!userComment.trim().match(/^[\w\s.]+$/)) {
                errorMessage += 'Incorrect comment. IComment should not have a special symbols. ';
            }
    ...
    const handleSubmit = (e: SyntheticEvent) => {
        ...
        // Create payload for new IComment
